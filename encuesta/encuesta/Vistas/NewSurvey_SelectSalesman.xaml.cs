...
{
    public partial class NewSurvey_SelectSalesman : ContentPage
    {
        ...
        public NewSurvey_SelectSalesman()
        {
            InitializeComponent();
        ...
        async void BtnSalesman_OnClickItem(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            await Navigation.PushAsync(new Vistas.NewSurvey_SelectCustomer(_selectedSalesman));
